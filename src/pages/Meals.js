...
export default function Foods() {
  ...
  const numberOfCards = meals !== null ? meals.slice(START_CARD, NUMBER_CARDS) : null;
  ...
  console.log('base', filteredMeals);
  console.log('fil', baseDataMeals);
  console.log('render', numberOfCards);

  return (
    <div>
      <Header />
      <section className="container-cards">
        {numberOfCards === null ? 'teste'
