...
describe('Testes para tela de receitas feitas', () => {
  ...
  it('Verifica se o botao de filtro food funciona', () => {
    ...
    expect(screen.getByTestId(/0-horizontal-name/i)).toHaveTextContent(doneRecipes[0].name);
  ...
  it('Verifica se o botao de filtro drink funciona', () => {
    ...
    expect(screen.getByTestId(/0-horizontal-name/i)).toHaveTextContent(doneRecipes[1].name);
    expect(screen.queryByTestId(/1-horizontal-name/i)).toBeNull();
  });
  ...
  it('Verifica se o botao de filtro all funciona', () => {
    ...
    userEvent.click(all);
    expect(screen.getByTestId(/0-horizontal-name/i)).toHaveTextContent(doneRecipes[0].name);
    expect(screen.getByTestId(/1-horizontal-name/i)).toHaveTextContent(doneRecipes[1].name);
  });
